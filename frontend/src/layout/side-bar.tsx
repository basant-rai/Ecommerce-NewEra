                ...
                <Link to="#" className="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:text-white dark:text-gray-300 dark:hover:bg-gray-600" role="menuitem">
                  <div className="inline-flex items-center">
                    {/* <svg aria-hidden="true" className="h-3.5 w-3.5 rounded-full mr-2" xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-cn" viewBox="0 0 512 512">
                      ...
                      <use width="30" height="20" transform="matrix(76.8 0 0 76.8 128 128)" xlink:to="#a" />
                      <use width="30" height="20" transform="rotate(-121 142.6 -47) scale(25.5827)" xlink:to="#a" />
                      <use width="30" height="20" transform="rotate(-98.1 198 -82) scale(25.6)" xlink:to="#a" />
                      <use width="30" height="20" transform="rotate(-74 272.4 -114) scale(25.6137)" xlink:to="#a" />
                      <use width="30" height="20" transform="matrix(16 -19.968 19.968 16 256 230.4)" xlink:to="#a" />
                    </svg> */}
                    中文 (繁體)
                  </div>
                </Link>
